 ...
 *
 */
public class Basket_Roller_Joystick_Out extends Command {

	private static final double BUTTONS_JOYSTICK_DEADZONE = 0.05;
	
    public Basket_Roller_Joystick_Out() {
 ...
 // Called just before this Command runs the first time
    ...
    protected void execute() {
        ...
        double Speed = ImpiLib.signedSquare(ImpiLib.deadzone(buttonsController.getTriggerR(),BUTTONS_JOYSTICK_DEADZONE));
