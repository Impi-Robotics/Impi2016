...
public class RobotMap {
	...
	//XBOX Controller Assignment
	   public static final int PORT__OI__DRIVER_CONTROLLER = 0;
	   public static final int PORT__OI__BUTTONS_CONTROLLER = 1;
	
	//PWM Motor Assignments
	   public static final int PWM__CHASSIS__RIGHT_FRONT_MOTOR = 2;
       public static final int PWM__CHASSIS__LEFT_FRONT_MOTOR = 0;
       public static final int PWM__CHASSIS__RIGHT_REAR_MOTOR = 1;
       public static final int PWM__CHASSIS__LEFT_REAR_MOTOR = 4;
	...
	//Analog IO
	public static int AIO__ANALOG__POTENTIOMETER = 1;
	public static final int PWM__TESTMOTOR__1 = 5;
}
